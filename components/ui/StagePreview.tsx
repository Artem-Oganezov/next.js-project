...
export default function StagePreview({ dinoColor = "var(--coral)", tall }: StagePreviewProps) {
  return (
    <div className={`stage-preview${tall ? " stage-preview-tall" : ""}`} aria-hidden>
      <div className="stage-sun" />
      <div className="stage-cloud" style={{ top: 14, left: 30, width: 30, height: 14 }} />
      <div className="stage-cloud" style={{ top: 24, right: 50, width: 22, height: 10 }} />
